...
\addbibresource{../str-templates/sample-resources/bibliographies/str.bib} % TODO: Replace with real .bib file
...
\begin{document}
	...
	\makeapprovalsheet{
		\noindent This research paper has been approved for submission in fulfillment of the requirements in Research \the\level.

		{\centering
			\signatureline{Jay Jay F. Manuel} {Research Teacher}
		}

		\vspace{3\baselineskip}

		\noindent This is to certify that the research paper has been accepted.

		{\centering
			\begin{multicols}{2}
				\signatureline{Marites P. Rivera} {Panel Member}
				\columnbreak
				\signatureline{Freda M. Wong} {Panel Member}
			\end{multicols}

			\signatureline{Ricarido M. Saturay, \NoCaseChange{Jr.}} {Panel Member}

			\vfill

			\signatureline{Melba C. Patacsil} {CID Chief}

			\signatureline{Conrado C. Rotor, \NoCaseChange{Jr., Ph.D.}} {Campus Director}
		}
	}
	...
	\chapter{Raw Data}
		...
		\lstinputlisting[caption={game.py}, label={lst:game.py}]{../str-templates/sample-resources/code/game.py}

	...
	\chapter{MATERIALS AND METHODS}
		...
		\section{Procedures}
			\subsection{Software Development}
				...
				This will be coded in Python, as application programming interfaces (APIs) for machine learning have already been implemented in Python.

				After the development of a platform for play of \ttt\ between trained organisms, the development of the required MGs will then follow.
				...
				\paragraph{Genetic Algorithm}
					The organisms to be trained will then be implemented in Python as well.
					The GA will be composed of unique genomes with genes for each possible game state with alleles that correspond to the moves to be taken.
